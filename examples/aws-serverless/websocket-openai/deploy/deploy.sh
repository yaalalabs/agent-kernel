...
create_request_handler_deployment_package() {
    ...
    if [[ ${1-} != "local" ]]; then
      ...
      uv pip install --target=dist_request_handler --find-links ../../../ak-py/dist --upgrade-package agentkernel --reinstall-package agentkernel agentkernel[aws,redis]
    fi
...
create_agent_runner_deployment_package() {
    ...
    if [[ ${1-} != "local" ]]; then
      ...
      uv pip install --target=dist_agent_runner/data --find-links ../../../ak-py/dist --upgrade-package agentkernel --reinstall-package agentkernel agentkernel[aws,openai,redis]
    fi
...
create_response_handler_deployment_package() {
    ...
    if [[ ${1-} != "local" ]]; then
      ...
      uv pip install --target=dist_response_handler --find-links ../../../ak-py/dist --upgrade-package agentkernel --reinstall-package agentkernel agentkernel[aws,redis]
    fi
...
create_ws_connection_handler_deployment_package() {
    ...
    if [[ ${1-} != "local" ]]; then
      ...
      uv pip install --target=dist_ws_connection_handler --find-links ../../../ak-py/dist --upgrade-package agentkernel --reinstall-package agentkernel agentkernel[aws,redis]
    fi
