...
def main():
    ...
    parser.add_argument(
        "--table-name",
        default="ak-oai-scl-ecs-dev-response-store",
        help="DynamoDB table name (default: ak-oai-scl-ecs-dev-response-store)",
    )
    parser.add_argument("--list", action="store_true", help="List all responses in the table")
    parser.add_argument("--clear", action="store_true", help="Clear all responses from the table")
