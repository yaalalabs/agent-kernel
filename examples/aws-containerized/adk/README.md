# Agent Kernel running Google ADK based agents in AWS Containered (ECS)

This package contains a demo of Agent Kernel running agents built with Google ADK, running them in a containered configuration using AWS ECS.
