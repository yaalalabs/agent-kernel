...
async def http_client():
    ...
    my_env["AK_INSTAGRAM__ACCESS_TOKEN"] = "IGAABsbCS1iHgBO6YjZCiVnqhNGZBfvDKZCw"
    my_env["AK_INSTAGRAM__VERIFY_TOKEN"] = "test_verify_token_12345"
...
@pytest.mark.asyncio
async def test_instagram_agent(http_client):
    print("test_instagram_agent")
