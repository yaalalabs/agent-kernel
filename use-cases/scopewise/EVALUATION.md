...
Status: development snapshot, 2026-08-31. Read this before describing ScopeWise as production-ready.

## What was exercised

- Automated unit/API checks cover ownership, CSRF, file rejection, bounded body bytes, source quote validation, objective-specific citations, explicit exclusions, partial coverage, duplicate removal, changing lecturers/syllabuses, changing a reviewed judgment, stale exports, failed/interrupted model jobs, manual review, Telegram linking/secrets/replay, and a temporary SQLite backup/restore.
...
- The desktop browser was used for account creation, loading the labeled sample, source upload/inspection/approval, objective review, pack creation, coverage-gap display and lecturer-change invalidation. A 390px mobile viewport had no horizontal document overflow.
...
## The local model is not yet a release-quality classifier
