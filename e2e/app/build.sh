...
if [[ ${1-} != "local" ]]; then
  ...
  uv pip install --force-reinstall --no-deps --no-index --find-links ../../ak-py/dist agentkernel[api,openai,slack,telegram,gmail,whatsapp,messenger,instagram,teams] || true
fi
