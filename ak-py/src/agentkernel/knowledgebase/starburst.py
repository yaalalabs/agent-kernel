...
class StarburstManager(AbstractKnowledgeBase):
    def __init__(self):
    ...
    def add_records(self, records: Iterable[Mapping[str, Any]], **kwargs) -> None:
        """
    ...
    def search_records(self, query: str, limit: int = 3, **kwargs) -> List[Dict[str, Any]]:
        try:
