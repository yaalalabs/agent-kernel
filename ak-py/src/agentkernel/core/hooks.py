...
class Posthook:
    ...
    def on_post_execution(self, session: Session, input_prompt: str,  agent: Agent, agent_reply: str ) -> str:
        ...
        Args:
            session (Session): The session instance.
            input_prompt (str): The original prompt provided to the agent.
            agent (Agent): The agent that executed the prompt.
            agent_reply (str): The reply generated by the agent, unmodified.

        Returns:
            str: The modified reply. If not modified, return the current reply.
        """
        pass
