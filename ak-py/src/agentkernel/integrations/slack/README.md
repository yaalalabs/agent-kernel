...
1. When a message is recieved from slack addressed to the bot it will first acknowledged with a message ("agent_acknowledgement" ) and processing emoji, if its defined in the config 
