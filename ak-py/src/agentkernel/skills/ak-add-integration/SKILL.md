...
```toml
dependencies = [
    "agentkernel[openai,api,slack]>=0.6.1",
]
```
...
```toml
dependencies = [
    "agentkernel[openai,api,whatsapp]>=0.6.1",
]
```
...
```toml
dependencies = [
    "agentkernel[openai,api,messenger]>=0.6.1",
]
```
...
```toml
dependencies = [
    "agentkernel[openai,api,instagram]>=0.6.1",
]
```
...
```toml
dependencies = [
    "agentkernel[openai,api,telegram]>=0.6.1",
]
```
...
```toml
dependencies = [
    "agentkernel[openai,api,gmail]>=0.6.1",
]
```
...
```toml
dependencies = [
    "agentkernel[openai,api,teams]>=0.6.1",
]
```
...
```toml
dependencies = [
    "agentkernel[openai,api,slack,whatsapp,telegram]>=0.6.1",
]
```
