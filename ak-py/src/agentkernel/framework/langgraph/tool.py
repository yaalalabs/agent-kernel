...
class LangGraphToolBuilder:
    """
    LangGraphToolBuilder provides a mechanism to bind generic tool functions
    to LangGraph, automatically injecting ToolContext when needed.
    ...
    def bind(
        ...
        """
        Bind generic tool functions for use with LangGraph.
        ...
        :return: List of wrapped tool functions compatible with LangGraph.
        """
        bindings = []
        ...
        for tool in tools:
            bindings.append(LangGraphToolBuilder._wrap_tool(tool, runtime, session, agent, requests, params))
