    ...
    async def _handle_message(self, message: dict, value: dict):
        ...
        if message_type == "text":
            ...
            try:
                ...
                self._log.error(f"Error downloading image: {e}")
                text += "\n(Note: Failed to download image)"
            ...
            try:
                ...
                self._log.error(f"Error downloading document: {e}")
                text += "\n(Note: Failed to download document)"
