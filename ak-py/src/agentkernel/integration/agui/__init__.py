...
by `SystemToolFactory`, so it cannot live here. Its contents are named for AG-UI like everything else;
only the filename is surface-neutral, so `core/` carries no integration name in its listing.
"""
